...
printf("Populacao: Carta 1 (%lu) e maior que Carta 2 (%lu)? %d\n", populacao1, populacao2, populacao1 > populacao2);

// Comparação de área
printf("Area: Carta 1 (%.2f Km²) e maior que Carta 2 (%.2f Km2)? %d\n", area1, area2, area1 > area2);

// Comparação de PIB
printf("PIB: Carta 1 (%.2f bilhoes) e maior que Carta 2 (%.2f bilhoes)? %d\n",  pib1, pib2, pib1 > pib2);

// Comparação de pontos turísticos
printf("Pontos Turisticos: Carta 1 (%d) e maior que Carta 2 (%d)? %d\n",  pontos1, pontos2, pontos1 > pontos2);

// Comparação de densidade populacional
printf("Densidade Populacional: Carta 1 (%.2f hab/Km²) e menor que Carta 2 (%.2f hab/Km2)? %d\n",  densidade1, densidade2, densidade1 < densidade2);

// Comparação de PIB per capita
printf("PIB per Capita: Carta 1 (%.2f) e maior que Carta 2 (%.2f)? %d\n",  pib_per_capita1, pib_per_capita2, pib_per_capita1 > pib_per_capita2);

// Comparação de super poder
printf("Super Poder: Carta 1 (%.2f) e maior que Carta 2 (%.2f)? %d\n",  superPoder1, superPoder2, superPoder1 > superPoder2);
